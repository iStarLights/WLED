#ifndef ISTAR_CONST_H
#define ISTAR_CONST_H
...
#define DEFAULT_OTA_PASS    "istarota"

//increase if you need more
#ifndef ISTAR_MAX_USERMODS
  #ifdef ESP8266
    #define ISTAR_MAX_USERMODS 4
  #else
    #define ISTAR_MAX_USERMODS 6
  #endif
#endif

#ifndef ISTAR_MAX_BUSSES
  #ifdef ESP8266
    #define ISTAR_MAX_BUSSES 3
  #else
    #ifdef CONFIG_IDF_TARGET_ESP32S2
      #define ISTAR_MAX_BUSSES 5
    #else
      #define ISTAR_MAX_BUSSES 10
    #endif
  #endif
#endif

#ifndef ISTAR_MAX_BUTTONS
  #ifdef ESP8266
    #define ISTAR_MAX_BUTTONS 2
  #else
    #define ISTAR_MAX_BUTTONS 4
  #endif
#endif

#ifdef ESP8266
#define ISTAR_MAX_COLOR_ORDER_MAPPINGS 5
#else
#define ISTAR_MAX_COLOR_ORDER_MAPPINGS 10
#endif
...
#define DMX_MODE_EFFECT           3            //trigger standalone effects of ISTAR (11 channels)
...
#define ISTAR_NUM_ETH_TYPES        8

#define ISTAR_ETH_NONE             0
#define ISTAR_ETH_WT32_ETH01       1
#define ISTAR_ETH_ESP32_POE        2
#define ISTAR_ETH_WESP32           3
#define ISTAR_ETH_QUINLED          4
#define ISTAR_ETH_TWILIGHTLORD     5
#define ISTAR_ETH_ESP32DEUX        6
...
// PWM settings
#ifndef ISTAR_PWM_FREQ
#ifdef ESP8266
  #define ISTAR_PWM_FREQ    880 //PWM frequency proven as good for LEDs
#else
  #define ISTAR_PWM_FREQ  19531
#endif
#endif
...
#ifdef ISTAR_USE_DYNAMIC_JSON
  #define MIN_HEAP_SIZE JSON_BUFFER_SIZE+512
#else
  #define MIN_HEAP_SIZE 4096
#endif

// Maximum size of node map (list of other ISTAR instances)
#ifdef ESP8266
  #define ISTAR_MAX_NODES 24
#else
  #define ISTAR_MAX_NODES 150
#endif
