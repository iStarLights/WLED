...
/*
 * Welcome! 
 * You can use the file "my_config.h" to make changes to the way ISTAR is compiled!
 ...
 * 
 * ArduinoIDE: Make a copy of this file and name it "my_config.h". Go to istar.h and uncomment "#define ISTAR_USE_MY_CONFIG" in the top of the file.
 * 
