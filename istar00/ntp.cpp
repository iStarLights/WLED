...
#include "istar.h"
#include "istar_math.h"

/*
 * Acquires time from NTP server
 */
//#define ISTAR_DEBUG_NTP
...
{
  if (ntpEnabled && ntpConnected && millis() - ntpLastSyncTime > (1000*NTP_SYNC_INTERVAL) && ISTAR_CONNECTED)
  {
