...
// deserializes ISTAR state (fileDoc points to doc object if called from web server)
...
void serializeInfo(JsonObject root)
{
  ...
  os += 0x10;
  #endif
  #ifndef ISTAR_DISABLE_FILESYSTEM
  os += 0x08;
  #endif
