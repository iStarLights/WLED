...
void loadSettingsFromEEPROM()
{
  ...
  //2560 - 2943 usable, NOT reserved (need to increase EEPSIZE accordingly, new ISTAR core features may override this section)
...
void deEEP() {
  if (ISTAR_FS.exists("/presets.json")) return;
  ...
  File f = ISTAR_FS.open("/presets.json", "w");
  if (!f) {
